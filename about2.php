	...
	<div id="container">
		...
		<div class="menu-box">
				<ul class="menu">
					...
					<li><a class="active" href="#"><span>Quienes Somos</span></a></li>
					...
					<div class="about-box">
						<div class="about-content">
							<div class="about-section">
								...
								<p>El sitio se llama denunciaya.com es un ente oficial para controlar las denuncias que realiza la comunidad.  </p>								
							</div>
								...
								<ul>
									<li>
										<div class="client-test">
											<img alt="" src="images/cliente2.jpg">
											<h3>Jennifer Mora</h3>
										</div>
										<p>Estoy muy agradecida por atender a mi denuncia lo más pronto posible, gracias por valorar 
                                        mi queja y darme la solución.</p>
									</li>
									<li>
										<div class="client-test">
