...
<html lang="es">
	<head>
		<meta charset ="utf-8">
		<title> Actualizar EstadoDenucia </title>
...
echo "<nav class='navbar navbar-default'>";
    ...
    echo "<div class='navbar-header'><a class='navbar-brand' >Tabla EstadoDenucia</a></div>";
...
<form method= "POST" class="form-horizontal" action= "GuardarEstadoDenuncia.php?usuario=" >
